...
import data_access.InMemoryUserDataAccessObject; // Import the in-memory DAO
...
public class MainWithInMemory {
    ...
    public static void main(String[] args) {
        ...
        // Change this line to use the in-memory DAO.
        final InMemoryUserDataAccessObject userDataAccessObject = new InMemoryUserDataAccessObject(); // Updated line
